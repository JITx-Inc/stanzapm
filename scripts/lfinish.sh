...
gcc -g -std=gnu99 core/threadedreader.c runtime/driver.c compiler/exec-alloc.c build/linenoise.o build/ConvertUTF.o build/wcwidth.o build/cvm.o build/sha256.o lstanza.s -o lstanza -DPLATFORM_LINUX -D_GNU_SOURCE -lm -ldl -fPIC -I include -Lbin -lasmjit-linux -lstdc++ -lrt -lpthread
